...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //2. A button to launc the camera to take the picture
        //3. an image view to show the user the pitura was a taken
        //4. a button to send/save the post to our Parse server
        ...
        post.setImage(ParseFile(file))
         post.saveInBackground{exception ->
             if(exception != null){
                 ...
                 Toast.makeText(this, "Error trying to save post", Toast.LENGTH_SHORT).show()
             } else{
